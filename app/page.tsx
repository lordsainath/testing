...
export default function SnijalAquaWebsite() {
  ...
  const handleWhatsAppOrder = (size: string) => {
    const message = encodeURIComponent(
      `Hi SNIJAL AQUA, I'm interested in the ${size} pack.`
    );
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-[rgb(1,117,203)] font-medium">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex flex-col items-end space-y-1 text-sm">
                ...
                <a
                  href="mailto:admin@snideshinfo.com"
                  className="text-gray-600 text-xs hover:underline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  admin@snideshinfo.com
                </a>
              </div>
        ...
        <div className="container mx-auto px-4 text-center relative">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Experience the purest form of hydration with our premium bottled
              water, sourced from the finest natural springs and processed with
            ...
            <div className="max-w-7xl mx-auto px-8 py-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 relative overflow-hidden">
              ...
              {[
                ...
                >
                  ...
                  <div
                    className={`mx-auto mb-6 w-20 h-20 flex items-center justify-center rounded-2xl bg-gradient-to-br ${stat.gradient} text-3xl shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-12`}
                  >
                    {stat.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-4">
              Why Choose SNIJAL AQUA?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We don't just bottle water, we deliver purity, health, and trust
              in every drop.
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Choose from our range of premium bottled water, perfect for every
              occasion and lifestyle need.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className={`group hover:shadow-2xl transition-all duration-500 border-0 shadow-lg hover:-translate-y-4 relative ${
                  bottle.popular
                    ? "ring-2 ring-[rgb(1,117,203)] ring-opacity-50"
                    : ""
                }`}
              >
                {bottle.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-[rgb(1,117,203)] text-white px-4 py-1">
                      Most Popular
                    </Badge>
                  </div>
                )}
                <CardContent className="p-8 text-center">
                  <div className="mb-8">
                    ...
                    <p className="text-[rgb(1,117,203)] font-bold text-2xl mb-2">
                      {bottle.quantity}
                    </p>
                  ...
                  <div className="flex gap-2 justify-center">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `mailto:admin@snideshinfo.com?subject=Inquiry about ${bottle.size} bottles`
                        )
                      }
                    >
      ...
      <section id="process" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Discover how we ensure every drop meets the highest standards of
              purity and quality.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Multi-stage purification process",
                step: "02",
              },
              {
                icon: Factory,
              ...
              },
              {
                icon: Truck,
                title: "Safe Delivery",
                desc: "Hygienic packaging and fast delivery",
                step: "04",
              },
            ].map((process, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8 text-lg leading-relaxed">
              Started in Pune in 2024, SNIDESH INDIA PVT LTD has been committed
              to serving West & South India with the purest bottled water.
              SNIJAL, a proud sub-brand of SNIDESH, carries forward this mission
              by delivering premium quality hydration solutions that meet the
              highest standards of purity and taste, while building lasting
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-16">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center space-x-3 bg-gray-50 px-6 py-4 rounded-2xl"
                >
            ...
            {[
              ...
              >
                <CardContent className="p-8">
                  ...
                  <p className="text-[rgb(1,117,203)] text-sm font-semibold mb-4">
                    {director.position}
                  </p>
                  <div className="flex justify-center gap-4 mt-4">
                    <Button
                      size="icon"
                      variant="outline"
                      className="border-[rgb(1,117,203)] text-[rgb(1,117,203)] hover:bg-[rgb(1,117,203)] hover:text-white"
                      onClick={() =>
                        window.open("https://wa.me/919270212113", "_blank")
                      }
                      title="WhatsApp"
                    >
                    ...
                    <Button
                      ...
                      className="border-[rgb(1,117,203)] text-[rgb(1,117,203)] hover:bg-[rgb(1,117,203)] hover:text-white"
                      onClick={() =>
                        window.open("mailto:admin@snideshinfo.com")
                      }
                      title="Email"
                    >
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Snidesh Info Pvt. Ltd, Business District, City Pune,
                          Maharashtra 411001
                        </p>
                      </div>
                    </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Premium quality bottled water serving West & South India with
                the purest hydration solutions. Your health and satisfaction are
                our top priorities.
              </p>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 SNIDESH INDIA PVT LTD. All rights reserved. | Made
              with ❤️ for pure hydration
            </p>
          </div>
        </div>
      </footer>
